    ...
    <div>
      <header>
          <NavbarInicio/>
            ...
            <div>
            <img src="img/FondoP.gif" className="img-fluid" alt="FondoP" id="fPrint"/>
            </div>
          ...
          <div className="row">
              <div className="col-sm-6">
                <div className="card" id="Comunicado">
                  <img src="../img/Domi.gif" className="card-img-top" alt="imagen 5"/>
              ...
              <div className="col-sm-6">
                <div className="card" id="Contactanos">
                  <div className="card-body">
                    ...
                    <input className="form-control" type="email" placeholder="email@grupo13.com"/>
