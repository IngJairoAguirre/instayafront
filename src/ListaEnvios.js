...
function ListaEnvios() {
  ...
  useEffect(() => {
    axios
      .get(process.env.REACT_APP_BACK_URI+"/api/envio/obtenerenvios")
      //.get(process.env.BACK_URI+"/api/envio/obtenerenvios")
      .then((res) => {
  ...
  function borrarenvio(idenvio) {
       axios  
      .post(process.env.REACT_APP_BACK_URI+"/api/envio/borrarenvio", { idenvio: idenvio })
      .then((res) => {
        console.log(res.data);
        alert(res.data);
        navegar(0);
    ...
    isAuthenticated && (
      <div id="wrapper">
        <ul
          ...
          id="accordionSidebar"
        >
          <img src="img/Logo2.png" className="d-block  mx-auto" width="120" height="120" alt="img 1"/>
          <div class="sidebar-brand">InstaYa Grupo 13</div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          <div id="content">
            ...
            <div class="container-fluid">            
              <h5 class="h3 mb-2 text-red">Dashboard InstaYa Grupo 13</h5>
              <p class="mb-4"> Como usuario puedes crear y editar ordenes 😁✈️ 
                <p></p>
              </p>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h5 class="mb-3 font-weight-bold text-primary text-center"id="TitEnv">Envios Realizados</h5>
                  <a className="btn btn-primary col-13" href="agregarenvio">Nuevo Envio</a>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        {dataenvios.map((envio) => (
                          <tr key={envio}>
                            ...
                            <td>
                             {/* <button className="btn btn-danger" onClick="return confirmDelete()">Eliminar</button> */}                           
                              <button className="btn btn-danger" onClick={() => {borrarenvio(envio.idenvio);}}>Eliminar</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
          ...
          <center><img src="img/LogoDash.gif" className="d-block  mx-auto" width="520" height="150" alt="img 2"/></center>
            <div class="container my-auto">            
              <div class="copyright text-center my-auto">
                <span>Copyright &copy; InstaYa Jmedina Envios 2022</span>
              </div>
            </div>
          </footer>
        </div>
        ...
        >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              Seleccione "Cerrar Sesion" para finalizar su actual sesión.
              </div>
