...
function EditarEnvio() {
  ...
  useEffect(() => {
    axios
      //.post(process.env.REACT_APP_BACK_URI+"/api/envio/obtenerdataenvio", { idenvio: params.idenvio })
      .post(process.env.REACT_APP_BACK_URI+"/api/envio/obtenerdataenvio", { idenvio: params.idenvio })
      .then((res) => {
  ...
  function editarEnvio() {
    ...
    axios
      //.post(process.env.REACT_APP_BACK_URI+"/api/envio/actualizaenvio", actualizarenvio)
      .post(process.env.REACT_APP_BACK_URI+"/api/envio/actualizaenvio", actualizarenvio)
      .then((res) => {
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          <div class="container-fluid">
            <h1 class="h3 mb-2 text-red">Envios InstaYa Grupo 13</h1>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Selecc"Cerrar Sesion"si desea finalizar su actual sesión.
            </div>
